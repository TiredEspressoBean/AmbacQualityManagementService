...
from Tracker.authentication import TenantMembershipSessionAuthentication
...
@authentication_classes([TenantMembershipSessionAuthentication])  # browser session + tenant-membership check
