...
from .core import SecureModel, SecureManager, SecureQuerySet, User
...
class GeneratedReport(SecureModel):
    ...
    Tracks all PDF reports generated by the Typst report pipeline
    (see Tracker/reports/), providing compliance traceability for who
    requested what report and when. Supports QMS audit requirements for
    document control.
...
class CalibrationRecordQuerySet(SecureQuerySet):
...
class CalibrationRecordManager(SecureManager):
