...
> **Status (2026-09-21): shipped — historical record.** The CP-SAT services
> described here are live in `Tracker/services/scheduling/` — `solver.py` and
> `dispatch.py` are the two that build models. Treat this as the design
> rationale; the code is authoritative where they differ. Companion plan:
