...
| Audit | `PartsTrackerApp/settings.py`, `Tracker/models/core.py`, `Tracker/management/commands/setup_audit_triggers.py` |
| Configuration | `Tracker/models/core.py` (SecureModel), `Tracker/models/spc.py` |
| Identification | `Tracker/models/core.py` (User), `PartsTrackerApp/settings.py` (AUTH config) |
